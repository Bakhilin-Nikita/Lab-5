package server7.inputCmdCollection;

import server7.UpdateCommand;
import server7.commands.ExecuteScript;
import server7.commands.Invoker;
import server7.commands.inputCommands.RemoveById;
import server7.commands.inputCommands.Update;
import server7.commands.inputCommands.UpdateElementCommand;
