...
public class LabWork implements Serializable {
    ...
    private server.object.Coordinates coordinates = new server.object.Coordinates(); //Поле не может быть null
    //Поле не может быть null, Значение этого поля должно генерироваться автоматически
    private int minimalPoint; //Значение поля должно быть больше 0
    private Integer tunedInWorks;
    private Difficulty difficulty; //Поле может быть null
    private server.object.Person author; //Поле не может быть null

    private String creationDateString;  //Поле не может быть null, Значение этого поля должно генерироваться автоматически

    public LabWork(int id, String name, int minimalPoint, Long tunedInWorks, Difficulty difficulty, server.object.Coordinates coordinates, server.object.Person author, String creationDateString) {
        this.id = id;
    ...
    public LabWork(int id, String name, int minimalPoint, Long tunedInWorks, Difficulty difficulty, server.object.Coordinates coordinates, server.object.Person author) {
        this.id = id;
        this.name = Objects.requireNonNull(name);
        this.coordinates = Objects.requireNonNull(coordinates);
        this.minimalPoint = minimalPoint;
    ...
    public LabWork(String name, int minimalPoint, Long tunedInWorks, Difficulty difficulty, server.object.Coordinates coordinates, server.object.Person author) {
        this.name = Objects.requireNonNull(name);
        this.coordinates = Objects.requireNonNull(coordinates);
        this.minimalPoint = minimalPoint;
        this.author = Objects.requireNonNull(author);
    ...
    public void setAuthor(server.object.Person author) {
        this.author = author;
    }
    ...
    public void setCoordinates(server.object.Coordinates coordinates) {
