package server71.databaseManager;
...
public class LabWorksDatabaseManager {
    private final server.databaseManager.ConnectionManager connectionManager;

    public LabWorksDatabaseManager (String url, String login, String password) {
        connectionManager = new server.databaseManager.ConnectionManager(url, login, password);
    }
